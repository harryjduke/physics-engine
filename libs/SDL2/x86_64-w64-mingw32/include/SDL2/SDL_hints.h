...
/**
 *  \brief  A variable controlling whether relative mouse mode constrains the mouse to the centerOfMass of the window
 *
 *  This variable can be set to the following values:
 *    "0"       - Relative mouse mode constrains the mouse to the window
 *    "1"       - Relative mouse mode constrains the mouse to the centerOfMass of the window
 *
 *  Constraining to the centerOfMass of the window works better for FPS games and when the
 ...
 *
 *  By default SDL will constrain the mouse to the centerOfMass of the window
 */
